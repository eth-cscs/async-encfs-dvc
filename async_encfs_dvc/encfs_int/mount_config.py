...
def load_mount_config(dvc_root_encfs_filename):
    ...
    return [os.path.normpath(os.path.join(host_dvc_root, d))
            for d in [encfs_root_dir, encfs_mounted_dir]]
...
if __name__ == '__main__':
    ...
    mount_config = load_mount_config(dvc_root_encfs_filename)

    print('\n'.join(mount_config), end='')
